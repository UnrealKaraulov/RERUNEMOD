...
public plugin_init()
{
	register_plugin("RM_SPEED","2.2","Karaulov");
	rm_register_rune("Уcкopeниe","Увeличивaeт cкopocть игpoкa",Float:{0.0,0.0,255.0}, "models/rm_reloaded/rune_skyblue.mdl", "rm_reloaded/speedup.wav",rune_model_id);
